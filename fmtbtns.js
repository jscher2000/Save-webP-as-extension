...
function handleMessage(request, sender, sendResponse){
	if ('download' in request){
		...
		oPrefs.btnpng = oSettings.btnpng;
		oPrefs.btnjpg100 = oSettings.btnjpg100;
		oPrefs.btnjpg92 = oSettings.btnjpg92;
		oPrefs.btnjpg85 = oSettings.btnjpg85;
		oPrefs.btnjpg80 = oSettings.btnjpg80;
		oPrefs.btnjpg75 = oSettings.btnjpg75;
		oPrefs.btndark = oSettings.btndark;
		oPrefs.saveas = oSettings.saveas;
		oPrefs.usefolder = oSettings.usefolder;
		// More to be added here in the future
		oPrefs.keepprivate = oSettings.keepprivate;
